...
var MovieFinder = function (_React$Component) {
    ...
    _createClass(MovieFinder, [{
        ...
        value: function handleSubmit(event) {
            ...
            var movieSearch = this.state.movieSearch;
            ...
            fetch("https://www.omdbapi.com/?s=" + movieSearch + "&apikey=dc8825e2").then(checkStatus).then(json).then(function (data) {
        ...
        value: function render() {
            var _state = this.state,
                movieSearch = _state.movieSearch,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement("input", { type: "text", placeholder: "frozen", value: movieSearch, onChange: this.handleChange, className: "form-control mr-sm-2" }),
                            React.createElement(
                                "button",
